 ...
 */
@Singleton
public class ClusterAllowDupFromZK implements Cluster, IZkChildListener, IZkDataListener, IZkStateListener {

    private static Logger logger = LoggerFactory.getLogger(ClusterAllowDupFromZK.class);
     ...
     */
    @Inject
    public ClusterAllowDupFromZK(@Named("s4.cluster.name") String clusterName,
     ...
     * any topology
     */
    public ClusterAllowDupFromZK(String clusterName, ZkClient zkClient, String machineId) throws Exception {
